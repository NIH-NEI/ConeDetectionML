...
"""
PyInstaller spec for building ConeDetectionML.app on macOS.
...
app = BUNDLE(
    coll,
    name="ConeDetectionML.app",
    icon="Icons/ConeDetectionML256x256.icns",
    bundle_identifier="org.local.ConeDetectionML",
    info_plist={
        "CFBundleName": "ConeDetectionML",
        "CFBundleDisplayName": "ConeDetectionML",
        "CFBundleExecutable": "ConeDetectionML",
