...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _open_image_list(self, img_filenames, save_state=False):
        ...
        for idx, img_name in enumerate(img_filenames):
            ...
            # for fr, pts in aa.items():
            #     if len(pts) > 0 and self._file_io.is_annotation_spaced(pts, imdat.itk_img):
            #         self._file_io.scale_annotations(pts, imdat.itk_img)
        ...
        for i, row in enumerate(c_rows):
            ...
            if imdat.nframes > 1:
                ...
                for fr in range(imdat.nframes):
                    ...
                    detection_pts = self._detection.detect_cones(itk_img, self._detection_para_dlg.image_fov,
                ...
                detection_pts = self._detection.detect_cones(imdat.itk_img, self._detection_para_dlg.image_fov,
                            self._detection_para_dlg.probablity_threshold, self._detection_para_dlg.clustering_radius)
