...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _setup_toolbar(self):
        ...
        open_image_button.setToolTip("Open Images/Annotations (Ctrl+O)")
        ...
        open_annotation_button.setToolTip("Open Annotations")
        ...
        save_data_button.setToolTip("Save Annotations (Ctrl+S)")
