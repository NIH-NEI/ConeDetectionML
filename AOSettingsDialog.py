...
class ao_parameter_dialog(QtWidgets.QDialog):
    ...
    def _setup_layout(self):
        ...
        self._clustering_radius_input.setValue(10)
    ...
    def get_state(self):
        jobj = {
            ...
            'probablity_threshold': self.get_probablity_threshold(),
    ...
    def set_state(self, jobj):
        try:
            if 'probablity_threshold' in jobj:
                self._probability_threshold_input.setValue(float(jobj['probablity_threshold']))
            if 'clustering_radius' in jobj:
                self._clustering_radius_input.setValue(jobj['clustering_radius'])
